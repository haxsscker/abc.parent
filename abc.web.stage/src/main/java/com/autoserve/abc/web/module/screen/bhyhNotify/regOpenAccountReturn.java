...
public class regOpenAccountReturn {
	private final static Logger logger = LoggerFactory.getLogger(regOpenAccountReturn.class);
    @Resource
...
//	            	nav.redirectToLocation("/account/myAccount/AccountOverview");
	            	//注册新流程
	            	nav.redirectToLocation("/register/toregister?step=3");

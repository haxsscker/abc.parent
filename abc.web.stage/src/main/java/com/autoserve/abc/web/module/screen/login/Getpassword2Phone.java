...
public class Getpassword2Phone {
	...
	public void execute(Context context, Navigator nav, ParameterParser params) {
		...
		PageResult<UserDO> result = userService.queryListMobile(userdo, null,
				null, new PageCondition());
		...
		boolean isSend = sendMsgService.sendMsg(userdo.getUserPhone(), content,
				userdo.getUserName(), "2");
		if (!isSend) {

...
public class AppWithdrawsNotify {
	private final static Logger logger = LoggerFactory.getLogger(AppWithdrawsNotify.class);
    @Resource
...
//					}
					...
					if(!"0".equals(MerPriv)){
				        ...
				        dealRecordDo.setDrType(DealType.TOCASH.getType());

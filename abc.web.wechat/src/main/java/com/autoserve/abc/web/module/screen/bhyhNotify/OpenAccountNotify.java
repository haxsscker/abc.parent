...
//		String partner_id = FormatHelper.GBKDecodeStr(rspJsonObject.getString("PartnerId"));// 
//		String version_no = FormatHelper.GBKDecodeStr(rspJsonObject.getString("Version_No"));//
//		String biz_type = FormatHelper.GBKDecodeStr(rspJsonObject.getString("Biz_Type"));// 
//		String IdentType = FormatHelper.GBKDecodeStr(rspJsonObject.getString("IdentType"));
//		String FEE_AMT = FormatHelper.GBKDecodeStr(rspJsonObject.getString("Fee_Amt"));
//		String sign_type = FormatHelper.GBKDecodeStr(rspJsonObject.getString("Sign_Type"));// 
//		String charSet = rspJsonObject.getString("Char_Set");

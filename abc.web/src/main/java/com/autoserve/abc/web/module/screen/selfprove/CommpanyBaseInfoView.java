	...
	public void execute(Context context, @Param("cinId") Integer cinId) {
		if (cinId != 0) {
			...
			if (plainResult.isSuccess()) {
				...
				if (companyCustomerVO.getCcCompanyScale() != null) {
					context.put("ccCompanyScale", CcCompanyScale
							.valueOf(companyCustomerVO.getCcCompanyScale()).des);
				}
				if (companyCustomerVO.getCcCompanyType() != null) {
					context.put("ccCompanyType", CcCompanyType
							.valueOf(companyCustomerVO.getCcCompanyType()).des);
				}

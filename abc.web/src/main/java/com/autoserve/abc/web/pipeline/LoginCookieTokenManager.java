...
public class LoginCookieTokenManager {
     ...
     * cookie 默认最长有效时间
     */
    public static final int     defaultCookieMaxValidSeconds     = Integer.valueOf(SystemGetPropeties.getBossString("abc.cookieMaxValidSeconds"));
    ...
    private static String getCookieDomain(HttpServletRequest request) {
        ...
        if (StringUtil.indexOf(curServerName, "xh99d.com") > -1) {
            return "xh99d.com";

...
//            idField: "loanId",
            ...
            columns: [[
               ...
               { field: "in_transfer_date", title: "转让成交", width: 150, align: "right" },
               { field: "income_end", title: "是否结清", width: 80, align: "center" }
                    ]],
            pagination: true,
            singleSelect: true,
            onBeforeLoad: function(param){
            	param.loan_no = $("#loan_no").val();
            }
        });
    ...
    Search: function(){
         ...
         $.AjaxColynJson("/reportAnalysis/json/investorsReportView.json?"+ getParam(o) ,param, function (data) {

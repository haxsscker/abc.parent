...
public enum CommonResultCode implements IErrorCode, Serializable {
    ...
    CANCELSUCCESS(201, "流标成功"),
    
    ACCOUNTED(200, "您已开户"),
    INVEST_LOAN_ACCOUNTED(200, "您的投资户与融资户已开户"),
    NO_INVEST_LOAN_ACCOUNT(201, "您的投资户与融资户未开户"),
    NO_INVEST_ACCOUNT(201, "您的投资户未开户"),
    NO_LOAN_ACCOUNT(201, "您的融资户未开户"),
    
    // 默认错误
    DEFAULT_INTERNAL_ERROR(000, "内部错误"),

 ...
 */
@Service
public class BoHaiPayUserAccountServiceImpl implements UserAccountService {
    private static final Logger logger = LoggerFactory.getLogger(BoHaiPayUserAccountServiceImpl.class);
    @Resource
